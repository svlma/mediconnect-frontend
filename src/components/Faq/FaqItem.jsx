...
const FaqItem = ({ item }) => {
  const [isOpen, setIsOpen] = useState(false); // Corrected variable names and added missing '=' in useState
  const toggleAccordion = () => { // Corrected arrow function syntax
    setIsOpen(!isOpen); // Changed isopen to isOpen
  };
